...
public class DriveBackwards extends Command {
    ...
    private double timeMovingBackward = 3.0;
    ...
    protected void initialize() {
        timeMovingBackward = Robot.prefs.getDouble("Low_Goal_Duration", timeMovingBackward);
        Robot.driveTrain.setMaxOutput(0.60);
        Robot.gyroscope.reset();
        setTimeout(timeMovingBackward); // 15 ft 4 inches = 3 seconds 3 seconds in competition
    }
